...
export const TelegramIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M21.6 3.2c.5-.2 1 .2.9.8l-3.4 16.2c-.1.6-.8.9-1.3.6l-4.8-2.7-2.5 2.4c-.4.4-1 .2-1-.3l.1-3.8 8-7.2c.3-.3 0-.7-.4-.5l-9.8 6.1-3.9-1.2c-.6-.2-.6-1 .1-1.2L21.6 3.2z" />
  </svg>
);
...
export const RedditIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M24 12c0 1.5-1.3 2.8-3 3.2-.2 3.2-3.9 5.8-8.5 5.8S4.2 18.4 4 15.2C2.3 14.8 1 13.5 1 12c0-1.7 1.4-3 3.2-3.1.7-3 4-5.2 8.1-5.4l1.5-3.7 3.8.8a2.3 2.3 0 103.5 2 2.3 2.3 0 00-4.4-.7l-2.4-.5-1.2 2.9c4.2.2 7.6 2.4 8.3 5.4C22.6 9 24 10.3 24 12zM8.5 13.2a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm7 0a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm-7.4 3.7c.9.7 2.4 1.1 4 1.1s3.1-.4 4-1.1c.3-.2.3-.6.1-.9-.2-.3-.6-.3-.9-.1-.7.5-2 .9-3.2.9s-2.5-.3-3.2-.9c-.3-.2-.7-.2-.9.1-.2.3-.2.7.1.9z" />
  </svg>
);
...
export const PinterestIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12 2C6.5 2 2 6.2 2 11.6c0 4 2.4 7.5 5.9 8.8-.1-.7-.1-1.7 0-2.4l1.2-5.1s-.3-.6-.3-1.5c0-1.4.8-2.5 1.9-2.5.9 0 1.3.7 1.3 1.5 0 .9-.6 2.3-.9 3.6-.3 1.1.6 2 1.7 2 2.1 0 3.7-2.2 3.7-5.4 0-2.8-2-4.8-4.9-4.8-3.3 0-5.3 2.5-5.3 5.1 0 1 .4 2 .8 2.6.1.1.1.2.1.4l-.3 1.2c0 .2-.2.3-.4.2-1.3-.6-2.1-2.4-2.1-3.9 0-3.2 2.4-6.2 6.9-6.2 3.6 0 6.4 2.6 6.4 6 0 3.6-2.3 6.5-5.4 6.5-1.1 0-2.1-.6-2.4-1.3l-.7 2.6c-.3 1-1 2.2-1.5 2.9 1.1.3 2.2.5 3.4.5 5.5 0 10-4.2 10-9.6C22 6.2 17.5 2 12 2z" />
  </svg>
);
