...
export const toolsData: Tool[] = [
  ...
  { id: "5", name: "Express.js", description: "Backend routing & middleware", icon: "express" },
  { id: "6", name: "PostgreSQL", description: "Relational database systems", icon: "database" },
  { id: "7", name: "Supabase", description: "Backend-as-a-service & file storage", icon: "supabase" },
  { id: "8", name: "Firebase", description: "Authentication, realtime DB & cloud messaging", icon: "firebase" },
  { id: "9", name: "Docker", description: "Containerization & deployment workflows", icon: "docker" },
  { id: "10", name: "Git & GitHub", description: "Version control & collaboration", icon: "github" },
  { id: "11", name: "AWS", description: "Cloud infrastructure & services", icon: "aws" },
  { id: "12", name: "Azure", description: "Cloud hosting & enterprise services", icon: "azure" },
  { id: "13", name: "Google Maps API", description: "Maps, routing & geolocation services", icon: "map" },
  { id: "14", name: "Mapbox", description: "Custom maps & geospatial visualization", icon: "mapbox" },
  { id: "15", name: "FastAPI", description: "High-performance Python APIs", icon: "fastapi" },
  { id: "16", name: "Flask", description: "Lightweight Python backend services", icon: "flask" },
  { id: "17", name: "TensorFlow", description: "Machine learning model development", icon: "tensorflow" },
  { id: "18", name: "PyTorch", description: "Deep learning & AI research", icon: "pytorch" },
  { id: "19", name: "scikit-learn", description: "Classical machine learning pipelines", icon: "sklearn" },
  { id: "20", name: "ChatGPT / LLMs", description: "AI-powered automation & intelligence", icon: "chatgpt" },
  { id: "21", name: "Ollama", description: "Self-hosted local language models", icon: "ollama" },
  { id: "22", name: "Docker Compose", description: "Multi-container application orchestration", icon: "docker" },
  { id: "23", name: "PM2", description: "Node.js process management", icon: "server" },
  { id: "24", name: "WooCommerce", description: "E-commerce platforms & integrations", icon: "woocommerce" },
  { id: "25", name: "GraphQL", description: "Flexible API query language", icon: "graphql" },
  { id: "26", name: "NestJS", description: "Scalable Node.js backend framework with TypeScript", icon: "nest" },
{ id: "27", name: "Spring Boot", description: "Enterprise-grade Java backend development", icon: "spring" },
{ id: "28", name: "Laravel", description: "PHP framework for rapid backend & API development", icon: "laravel" },
